export const PROJECTS = [
...

  {
    slug: "brainwave",
    title: "BrainWave",
    subtitle: "AI Landing Page Concept",
    description:
      "Brainwave is a modern landing page for an AI chatbot ecosystem, built as a technical exercise to translate a complex design wireframe into code. I used this challenge to practice implementing intricate dark-mode layouts and high-fidelity UI components. It focuses on maintaining a sleek aesthetic while ensuring full responsiveness.",
...

  {
    slug: "cinetrack",
    title: "CineTrack",
    subtitle: "Movie Search & Analytics Lab",
    description:
